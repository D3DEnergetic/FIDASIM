...
PRO d3d_input,inputs                                    ;; Name of this file without .pro
...
;;-----------------------------------------------------
isource=6     											;; Beam source index (FIDASIM only simulates on NBI source)
fida_diag=''	   										;; Name of the FIDA diag
...
ydim1=100.												;; Minimum y value
ydim2=180.												;; Maximum y value
