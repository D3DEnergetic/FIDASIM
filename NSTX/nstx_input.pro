...
PRO nstx_input,inputs                                   ;; Name of this file without .pro

;;-----------------------------------------------------
;;				PREFIDA INPUT FILE
;;-----------------------------------------------------
shot=132800L											;; Shot Number
time=0.5    											;; Time 
runid='132800M05'   									;; runid of FIDASIM
device='NSTX'											;; D3D,NSTX,AUGD,MAST
result_dir='/p/fida/lstagner/NSTX/'  			        ;; Location where results will be stored /RESULTS/runid will be made
profile_dir='/p/fida/lstagner/NSTX/132800M05/'			;; Location of profile save files. EX: profile_dir+'shot/'+'dne142353.00505'

;;----------------------------------------------------
;; Fast-ion distribution function from transp
;;----------------------------------------------------
cdf_file='/p/fida/lstagner/NSTX/132800M05/132800M05_fi_2.cdf'   ;; CDF file from transp with the distribution funciton
...
diag=['ssNPA']									        ;; Name of the FIDA diag
equil=''											    ;; Name of equilibrium. Ex. for D3D EFIT02,if empty look for gfile in profile_dir
