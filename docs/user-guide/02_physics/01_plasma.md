...
In FIDASIM, the plasma parameters and fields are mapped onto a 3D cylindrical grid, and a boolean mask is used to indicate where the plasma and fields are well defined.
