...
subroutine write_birth_profile
    ...
    if(do_write) then
        ...
        call h5_set_dimension_name(fid, "/dens", 1, "beam_component", error)
        call h5_set_dimension_name(fid, "/dens", 2, "x", error)
        call h5_set_dimension_name(fid, "/dens", 3, "y", error)
        call h5_set_dimension_name(fid, "/dens", 4, "z", error)
        call h5_attach_dimension_scale(fid, "/dens", "/grid/x", 2, error)
        call h5_attach_dimension_scale(fid, "/dens", "/grid/y", 3, error)
        call h5_attach_dimension_scale(fid, "/dens", "/grid/z", 4, error)

        call h5_set_dimension_name(fid, "/ri_gc", 1, "cylindrical_component", error)
        call h5_set_dimension_name(fid, "/ri_gc", 2, "particle", error)

        call h5_set_dimension_name(fid, "/ri", 1, "cylindrical_component", error)
        call h5_set_dimension_name(fid, "/ri", 2, "particle", error)

        call h5_set_dimension_name(fid, "/vi", 1, "cylindrical_component", error)
        call h5_set_dimension_name(fid, "/vi", 2, "particle", error)

        call h5_set_dimension_name(fid, "/ind", 1, "grid_index", error)
        call h5_set_dimension_name(fid, "/ind", 2, "particle", error)
...
subroutine write_neutral_population(id, pop, error)
    ...
    call h5_set_dimension_name(fid_local, trim(dset_path), 2, "x", error)
    call h5_set_dimension_name(fid_local, trim(dset_path), 3, "y", error)
    call h5_set_dimension_name(fid_local, trim(dset_path), 4, "z", error)

    !Attach coordinate scales from /grid group
    call h5_attach_dimension_scale(fid_local, trim(dset_path), "/grid/x", 2, error)
    call h5_attach_dimension_scale(fid_local, trim(dset_path), "/grid/y", 3, error)
    call h5_attach_dimension_scale(fid_local, trim(dset_path), "/grid/z", 4, error)
    ...
    if(inputs%output_neutral_reservoir.eq.1) then
       ...
       call h5_set_dimension_name(fid_local, trim(dset_path), 1, "x", error)
       call h5_set_dimension_name(fid_local, trim(dset_path), 2, "y", error)
       call h5_set_dimension_name(fid_local, trim(dset_path), 3, "z", error)
       call h5_attach_dimension_scale(fid_local, trim(dset_path), "/grid/x", 1, error)
       call h5_attach_dimension_scale(fid_local, trim(dset_path), "/grid/y", 2, error)
       call h5_attach_dimension_scale(fid_local, trim(dset_path), "/grid/z", 3, error)
       ...
       call h5_set_dimension_name(fid_local, trim(dset_path), 1, "particle", error)
       call h5_set_dimension_name(fid_local, trim(dset_path), 2, "x", error)
       call h5_set_dimension_name(fid_local, trim(dset_path), 3, "y", error)
       call h5_set_dimension_name(fid_local, trim(dset_path), 4, "z", error)
       call h5_attach_dimension_scale(fid_local, trim(dset_path), "/grid/x", 2, error)
       ...
       call h5_set_dimension_name(fid_local, trim(dset_path), 1, "cartesian_component", error)
       call h5_set_dimension_name(fid_local, trim(dset_path), 2, "particle", error)
       call h5_set_dimension_name(fid_local, trim(dset_path), 3, "x", error)
       call h5_set_dimension_name(fid_local, trim(dset_path), 4, "y", error)
       call h5_set_dimension_name(fid_local, trim(dset_path), 5, "z", error)
       call h5_attach_dimension_scale(fid_local, trim(dset_path), "/grid/x", 3, error)
       call h5_attach_dimension_scale(fid_local, trim(dset_path), "/grid/y", 4, error)
       call h5_attach_dimension_scale(fid_local, trim(dset_path), "/grid/z", 5, error)
...
subroutine write_npa
    ...
    if(do_write.and.(inputs%calc_npa.ge.1)) then
        ...
        if(particles%nclass.gt.1) then
            call h5_set_dimension_name(fid, "/flux", 1, "energy", error)
            call h5_set_dimension_name(fid, "/flux", 2, "channel", error)
            call h5_set_dimension_name(fid, "/flux", 3, "particle_class", error)
        ...
        if((npart.gt.0).and.(inputs%calc_npa.ge.2)) then
            ...
            call h5_set_dimension_name(gid, "ri", 1, "cartesian_component", error)
            call h5_set_dimension_name(gid, "ri", 2, "particle", error)
            call h5_set_dimension_name(gid, "rf", 1, "cartesian_component", error)
            call h5_set_dimension_name(gid, "rf", 2, "particle", error)
            call h5_set_dimension_name(gid, "gci", 1, "cartesian_component", error)
            call h5_set_dimension_name(gid, "gci", 2, "particle", error)
...
subroutine write_spectra
    ...
    if(inputs%calc_brems.ge.1) then
        call h5_set_dimension_name(fid, "/brems", 1, "wavelength", error)
        call h5_set_dimension_name(fid, "/brems", 2, "channel", error)
        call h5_attach_dimension_scale(fid, "/brems", "/lambda", 1, error)
        call h5_attach_dimension_scale(fid, "/brems", "/radius", 2, error)
    endif
    ...
    if(inputs%calc_bes.ge.1) then
        if(inputs%stark_components.eq.0) then
            ...
            call h5_set_dimension_name(fid, "/fullstokes", 1, "stark_component", error)
            call h5_set_dimension_name(fid, "/fullstokes", 2, "stokes_parameter", error)
            call h5_set_dimension_name(fid, "/fullstokes", 3, "wavelength", error)
            call h5_set_dimension_name(fid, "/fullstokes", 4, "channel", error)
            call h5_attach_dimension_scale(fid, "/fullstokes", "/lambda", 3, error)
            call h5_attach_dimension_scale(fid, "/fullstokes", "/radius", 4, error)
            call h5_set_dimension_name(fid, "/halfstokes", 1, "stark_component", error)
            call h5_set_dimension_name(fid, "/halfstokes", 2, "stokes_parameter", error)
            call h5_set_dimension_name(fid, "/halfstokes", 3, "wavelength", error)
            call h5_set_dimension_name(fid, "/halfstokes", 4, "channel", error)
            call h5_attach_dimension_scale(fid, "/halfstokes", "/lambda", 3, error)
            call h5_attach_dimension_scale(fid, "/halfstokes", "/radius", 4, error)
            call h5_set_dimension_name(fid, "/thirdstokes", 1, "stark_component", error)
            call h5_set_dimension_name(fid, "/thirdstokes", 2, "stokes_parameter", error)
            call h5_set_dimension_name(fid, "/thirdstokes", 3, "wavelength", error)
            call h5_set_dimension_name(fid, "/thirdstokes", 4, "channel", error)
    ...
    if(inputs%calc_dcx.ge.1) then
        if(inputs%stark_components.eq.0) then
            ...
            call h5_set_dimension_name(fid, "/dcx", 1, "stark_component", error)
            call h5_set_dimension_name(fid, "/dcx", 2, "wavelength", error)
            call h5_set_dimension_name(fid, "/dcx", 3, "channel", error)
            call h5_set_dimension_name(fid, "/dcx", 4, "thermal_species", error)
            call h5_attach_dimension_scale(fid, "/dcx", "/lambda", 2, error)
            call h5_attach_dimension_scale(fid, "/dcx", "/radius", 3, error)
            !5D: dcxstokes(stark,4,lambda,chan,species)
            call h5_set_dimension_name(fid, "/dcxstokes", 1, "stark_component", error)
            call h5_set_dimension_name(fid, "/dcxstokes", 2, "stokes_parameter", error)
            call h5_set_dimension_name(fid, "/dcxstokes", 3, "wavelength", error)
            call h5_set_dimension_name(fid, "/dcxstokes", 4, "channel", error)
            call h5_set_dimension_name(fid, "/dcxstokes", 5, "thermal_species", error)
            call h5_attach_dimension_scale(fid, "/dcxstokes", "/lambda", 3, error)
            call h5_attach_dimension_scale(fid, "/dcxstokes", "/radius", 4, error)
        endif
    endif
    ...
    if(inputs%calc_halo.ge.1) then
        if(inputs%stark_components.eq.0) then
            ...
            call h5_set_dimension_name(fid, "/halo", 1, "stark_component", error)
            call h5_set_dimension_name(fid, "/halo", 2, "wavelength", error)
            call h5_set_dimension_name(fid, "/halo", 3, "channel", error)
            call h5_set_dimension_name(fid, "/halo", 4, "thermal_species", error)
            call h5_attach_dimension_scale(fid, "/halo", "/lambda", 2, error)
            call h5_attach_dimension_scale(fid, "/halo", "/radius", 3, error)
            !5D: halostokes(stark,4,lambda,chan,species)
            call h5_set_dimension_name(fid, "/halostokes", 1, "stark_component", error)
            call h5_set_dimension_name(fid, "/halostokes", 2, "stokes_parameter", error)
            call h5_set_dimension_name(fid, "/halostokes", 3, "wavelength", error)
            call h5_set_dimension_name(fid, "/halostokes", 4, "channel", error)
            call h5_set_dimension_name(fid, "/halostokes", 5, "thermal_species", error)
            call h5_attach_dimension_scale(fid, "/halostokes", "/lambda", 3, error)
            call h5_attach_dimension_scale(fid, "/halostokes", "/radius", 4, error)
        endif
    endif
...
subroutine write_neutrons
    ...
    if((inputs%dist_type.eq.1).and.(inputs%calc_neutron.ge.2)) then
        ...
        call h5_set_dimension_name(fid, "/weight", 4, "z", error)
        call h5_set_dimension_name(fid, "/weight", 5, "phi", error)
        ...
        call h5_set_dimension_name(fid, "/emissivity", 1, "r", error)
        call h5_set_dimension_name(fid, "/emissivity", 2, "z", error)
        call h5_set_dimension_name(fid, "/emissivity", 3, "phi", error)
    ...
    if((inputs%dist_type.eq.1).and.(inputs%calc_neut_spec.ge.1)) then
        if(particles%nclass.gt.1) then
            ...
            call h5_set_dimension_name(fid, "/flux", 1, "orbit_class", error)
            call h5_set_dimension_name(fid, "/flux", 2, "channel", error)
        else
            !flux(chan)
...
subroutine write_cfpd_weights
    ...
    if(inputs%dist_type.eq.1) then
        ...
        call h5_set_dimension_name(fid, "/flux", 1, "detector_energy", error)
        call h5_set_dimension_name(fid, "/flux", 2, "channel", error)
        call h5_attach_dimension_scale(fid, "/flux", "/earray", 1, error)

        call h5_set_dimension_name(fid, "/prob", 1, "detector_energy", error)
        call h5_set_dimension_name(fid, "/prob", 2, "channel", error)
        call h5_attach_dimension_scale(fid, "/prob", "/earray", 1, error)

        call h5_set_dimension_name(fid, "/gam", 1, "detector_energy", error)
        call h5_set_dimension_name(fid, "/gam", 2, "channel", error)
        ...
        call h5_set_dimension_name(fid, "/weight", 1, "detector_energy", error)
...
subroutine write_fida_weights
    ...
    call h5_set_dimension_name(fid, "/weight", 1, "wavelength", error)
    call h5_set_dimension_name(fid, "/weight", 2, "energy", error)
    call h5_set_dimension_name(fid, "/weight", 3, "pitch", error)
    call h5_set_dimension_name(fid, "/weight", 4, "channel", error)
    ...
    call h5_set_dimension_name(fid, "/fida", 1, "wavelength", error)
    ...
    call h5_set_dimension_name(fid, "/mean_f", 1, "energy", error)
    call h5_set_dimension_name(fid, "/mean_f", 2, "pitch", error)
    call h5_set_dimension_name(fid, "/mean_f", 3, "channel", error)
    ...
    call h5_set_dimension_name(fid, "/jacobian", 1, "energy", error)
    call h5_set_dimension_name(fid, "/jacobian", 2, "pitch", error)
    call h5_attach_dimension_scale(fid, "/jacobian", "/energy", 1, error)
    call h5_attach_dimension_scale(fid, "/jacobian", "/pitch", 2, error)

    call h5_set_dimension_name(fid, "/vpe_grid", 1, "energy", error)
    call h5_set_dimension_name(fid, "/vpe_grid", 2, "pitch", error)
    call h5_attach_dimension_scale(fid, "/vpe_grid", "/energy", 1, error)
    call h5_attach_dimension_scale(fid, "/vpe_grid", "/pitch", 2, error)

    call h5_set_dimension_name(fid, "/vpa_grid", 1, "energy", error)
    call h5_set_dimension_name(fid, "/vpa_grid", 2, "pitch", error)
    call h5_attach_dimension_scale(fid, "/vpa_grid", "/energy", 1, error)
    call h5_attach_dimension_scale(fid, "/vpa_grid", "/pitch", 2, error)

    call h5_set_dimension_name(fid, "/e_grid", 1, "energy", error)
    call h5_set_dimension_name(fid, "/e_grid", 2, "pitch", error)
    call h5_attach_dimension_scale(fid, "/e_grid", "/energy", 1, error)
    call h5_attach_dimension_scale(fid, "/e_grid", "/pitch", 2, error)

    call h5_set_dimension_name(fid, "/p_grid", 1, "energy", error)
    call h5_set_dimension_name(fid, "/p_grid", 2, "pitch", error)
...
subroutine write_npa_weights
    ...
    if(inputs%calc_npa_wght.ge.2) then !Write diagnostic variables
        ...
        call h5_set_dimension_name(fid, "/emissivity", 1, "x", error)
        call h5_set_dimension_name(fid, "/emissivity", 2, "y", error)
        call h5_set_dimension_name(fid, "/emissivity", 3, "z", error)
        call h5_set_dimension_name(fid, "/emissivity", 4, "channel", error)
        ...
        call h5_set_dimension_name(fid, "/attenuation", 1, "energy", error)
        call h5_set_dimension_name(fid, "/attenuation", 2, "x", error)
        call h5_set_dimension_name(fid, "/attenuation", 3, "y", error)
        call h5_set_dimension_name(fid, "/attenuation", 4, "z", error)
        call h5_set_dimension_name(fid, "/attenuation", 5, "channel", error)
        ...
        call h5_set_dimension_name(fid, "/cx", 1, "energy", error)
        call h5_set_dimension_name(fid, "/cx", 2, "x", error)
        call h5_set_dimension_name(fid, "/cx", 3, "y", error)
        call h5_set_dimension_name(fid, "/cx", 4, "z", error)
        call h5_set_dimension_name(fid, "/cx", 5, "channel", error)
        ...
        !phit(x,y,z,chan)
        call h5_set_dimension_name(fid, "/phit", 1, "x", error)
        call h5_set_dimension_name(fid, "/phit", 2, "y", error)
        call h5_set_dimension_name(fid, "/phit", 3, "z", error)
        call h5_set_dimension_name(fid, "/phit", 4, "channel", error)
