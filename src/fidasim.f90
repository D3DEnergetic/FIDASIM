...
subroutine pass_grid_intersect(r0, v0, length, r_enter, r_exit)
    ...
    real(Float64), dimension(3)            :: nz, n0, p, p0, p_dum
    ...
    call line_plane_intersect(r0, v0, vertex111_uvw, n0, p_arr(5,:), dt_arr(5))
    call rz_normal_vector(vertex112_uvw, vertex212_uvw, vertex122_uvw, n0)
    call line_plane_intersect(r0, v0, vertex112_uvw, n0, p_arr(6,:), dt_arr(6))
...
subroutine get_inter_grid_position(ind, pos, output_coords)
...
subroutine track_cylindrical(rin, vin, tracks, ntrack, los_intersect)
    ...
    track_loop: do i=1,pass_grid%ntrack
        ...
        call line_plane_intersect(ri, vn, v_plane, n0, p, dt_arr(3))
...
subroutine get_plasma(plasma, pos, ind, input_coords, output_coords)
    ...
    if(present(ind)) then
        ...
        if(ics.eq.2) then
            call get_inter_grid_position(ind,xyz,output_coords=0)
        endif
    endif
