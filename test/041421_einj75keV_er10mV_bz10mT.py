...
def run_test(args):
    ...
    basic_inputs = {"device":"test", "shot":1, "time":1.0,
                    ...
                    "calc_cfpd":0,
                    "calc_bes":1, "calc_dcx":0, "calc_halo":0, "calc_cold":0,
    ...
    equil["bz"] = 0.1*equil["bz"]/equil["bz"]
    equil["br"] = 0*equil["bz"]/equil["bz"]
    equil["bt"] = 0*equil["bz"]/equil["bz"]
    equil["ez"] = 0*equil["bz"]/equil["bz"]
    equil["et"] = 0*equil["bz"]/equil["bz"]
    equil["er"] = 0.1*equil["bz"]/equil["bz"]
